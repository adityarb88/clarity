...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__news_routing_module__ = __webpack_require__(430);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__news_component__ = __webpack_require__(412);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__release_page_release_pages__ = __webpack_require__(414);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__counters_breaking_change_directive__ = __webpack_require__(409);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__counters_bug_fix_directive__ = __webpack_require__(410);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__counters_new_component_directive__ = __webpack_require__(411);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__utils_component_list__ = __webpack_require__(398);
...
NewsModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_7__counters_breaking_change_directive__["a" /* BreakingChange */],
            __WEBPACK_IMPORTED_MODULE_8__counters_bug_fix_directive__["a" /* BugFix */],
            __WEBPACK_IMPORTED_MODULE_9__counters_new_component_directive__["a" /* NewComponent */],
            __WEBPACK_IMPORTED_MODULE_6__release_page_release_pages__["a" /* RELEASE_ROUTES */].map(__WEBPACK_IMPORTED_MODULE_10__utils_component_list__["a" /* componentList */]),
        ],
        imports: [
 ...
 * This software is released under MIT license.
 * The full license information can be found in LICENSE in the root directory of this project.
 */ function componentList(_a) {
    var component = _a.component;
    return component;
}
//# sourceMappingURL=/Users/adityab/fork-website-clarity/src/component-list.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__release_page_release_organizer__ = __webpack_require__(413);
...
var RELEASES = __webpack_require__(404);
var NewsComponent = (function () {
    function NewsComponent() {
        this.current = RELEASES.current;
        this.minors = __WEBPACK_IMPORTED_MODULE_1__release_page_release_organizer__["b" /* MINORS */]["0"];
        this.patches = __WEBPACK_IMPORTED_MODULE_1__release_page_release_organizer__["c" /* PATCHES */];
    }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return MINORS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return PATCHES; });
/* harmony export (immutable) */ __webpack_exports__["a"] = compareReleases;
var RELEASES = __webpack_require__(404);
var MAJORS = [];
var MINORS = {};
var PATCHES = {};
...
function compareReleases(rA, rB) {
    var splitA = rA.split(".").map(function (part) { return parseInt(part); });
    var splitB = rB.split(".").map(function (part) { return parseInt(part); });
    for (var i in splitA) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__releases_release_templates_stub__ = __webpack_require__(696);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__counters_breaking_change_directive__ = __webpack_require__(409);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__counters_bug_fix_directive__ = __webpack_require__(410);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__counters_new_component_directive__ = __webpack_require__(411);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__release_organizer__ = __webpack_require__(413);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RELEASE_ROUTES; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RELEASES = __webpack_require__(404);
var GENERIC_TEMPLATE = __webpack_require__(716);
var RELEASE_ROUTES = [];
var indexComponent;
for (var release in RELEASES.all) {
    if (__WEBPACK_IMPORTED_MODULE_1__releases_release_templates_stub__["a" /* TEMPLATES */][release]) {
        var template = GENERIC_TEMPLATE.replace("${content}", __WEBPACK_IMPORTED_MODULE_1__releases_release_templates_stub__["a" /* TEMPLATES */][release]);
        var releaseInfo = RELEASES.all[release];
        var component = createChangeLogComponent(release, releaseInfo);
        RELEASE_ROUTES.push({
            path: release,
            component: component,
            data: {
...
function createChangeLogComponent(releaseNumber, releaseInfo) {
    var template = GENERIC_TEMPLATE.replace("${content}", __WEBPACK_IMPORTED_MODULE_1__releases_release_templates_stub__["a" /* TEMPLATES */][releaseNumber]);
    var ChangelogComponent = (function () {
        function ChangelogComponent() {
            this.releaseNumber = releaseNumber;
            this.releaseInfo = releaseInfo;
            this.hasIcons = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__release_organizer__["a" /* compareReleases */])("0.5.4", releaseNumber) >= 0);
            this.hasGitHub = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__release_organizer__["a" /* compareReleases */])("0.6.0", releaseNumber) >= 0);
        }
    ...
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChildren"])(__WEBPACK_IMPORTED_MODULE_2__counters_breaking_change_directive__["a" /* BreakingChange */]),
        __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["QueryList"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["QueryList"]) === "function" && _a || Object)
    ], ChangelogComponent.prototype, "breakingChanges", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChildren"])(__WEBPACK_IMPORTED_MODULE_3__counters_bug_fix_directive__["a" /* BugFix */]),
    ...
    ], ChangelogComponent.prototype, "bugFixes", void 0);
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChildren"])(__WEBPACK_IMPORTED_MODULE_4__counters_new_component_directive__["a" /* NewComponent */]),
    ...
    ], ChangelogComponent.prototype, "newComponents", void 0);
...
//# sourceMappingURL=/Users/adityab/fork-website-clarity/src/release-pages.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__news_component__ = __webpack_require__(412);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__release_page_release_pages__ = __webpack_require__(414);
...
var newsRoutes = [
    {
        ...
        children: __WEBPACK_IMPORTED_MODULE_3__release_page_release_pages__["a" /* RELEASE_ROUTES */]
    }
];
 ...
 * It works fine with webpack, but angular-cli breaks them. See https://github.com/angular/angular-cli/issues/3306
 */ var TEMPLATES = {
    '0.9.1': __webpack_require__(1017),
    '0.9.0': __webpack_require__(1016),
    '0.8.16': __webpack_require__(1007),
    '0.8.15': __webpack_require__(1006),
    '0.8.14': __webpack_require__(1005),
    '0.8.13': __webpack_require__(1004),
    '0.8.12': __webpack_require__(1003),
    '0.8.11': __webpack_require__(1002),
    '0.8.10': __webpack_require__(1001),
    '0.8.9': __webpack_require__(1015),
    '0.8.8': __webpack_require__(1014),
    '0.8.7': __webpack_require__(1013),
    '0.8.6': __webpack_require__(1012),
    '0.8.5': __webpack_require__(1011),
    '0.8.4': __webpack_require__(1010),
    '0.8.3': __webpack_require__(1009),
    '0.8.2': __webpack_require__(1008),
    '0.8.1': __webpack_require__(1000),
    '0.8.0': __webpack_require__(999),
    '0.7.6': __webpack_require__(998),
    '0.7.5': __webpack_require__(997),
    '0.7.4': __webpack_require__(996),
    '0.7.3': __webpack_require__(995),
    '0.7.2': __webpack_require__(994),
    '0.7.1': __webpack_require__(993),
    '0.7.0': __webpack_require__(992),
    '0.6.4': __webpack_require__(991),
    '0.6.3': __webpack_require__(990),
    '0.6.2': __webpack_require__(989),
    '0.6.1': __webpack_require__(988),
    '0.6.0': __webpack_require__(987),
    '0.5.6': __webpack_require__(986),
    '0.5.5': __webpack_require__(985),
    '0.5.4': __webpack_require__(984),
    '0.5.3': __webpack_require__(983),
    '0.5.2': __webpack_require__(982),
    '0.5.1': __webpack_require__(981),
    '0.5.0': __webpack_require__(980),
    '0.4.3': __webpack_require__(979),
    '0.4.2': __webpack_require__(978),
    '0.4.1': __webpack_require__(977),
    '0.4.0': __webpack_require__(976),
    '0.3.6': __webpack_require__(975),
    '0.3.5': __webpack_require__(974),
    '0.3.4': __webpack_require__(973),
    '0.3.3': __webpack_require__(972),
    '0.3.2': __webpack_require__(971),
    '0.3.1': __webpack_require__(970),
    '0.3.0': __webpack_require__(969),
    '0.2.10': __webpack_require__(961),
    '0.2.9': __webpack_require__(968),
    '0.2.8': __webpack_require__(967),
    '0.2.7': __webpack_require__(966),
    '0.2.6': __webpack_require__(965),
    '0.2.5': __webpack_require__(964),
    '0.2.4': __webpack_require__(963),
    '0.2.3': __webpack_require__(962)
};
//# sourceMappingURL=/Users/adityab/fork-website-clarity/src/release-templates-stub.js.map
